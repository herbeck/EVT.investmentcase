    ...
    fluidRow(
      ...
      box(width=4, title="Scenario intervention parameters", status="warning", solidHeader=TRUE,
        ...
        sliderInput(paste0(id,"_int_sg"), "Maternal peer-support groups coverage", min=0, max=1, value=0, step=.05),
         "TLD/DTG regimen share", min=0, max=1, value=.80, step=.01),
      ...
      tabItem("about",
        box(width=12, title="About", status="primary", solidHeader=TRUE,
          ...
          tags$ul(
            ...
            tags$li(tags$b("Antiretroviral regimen shift (TLE → TLD): "), "transitioning PBFW from Efavirenz-based (TLE) to Dolutegravir-based (TLD) regimens, which are associated with higher viral suppression rates"),
          ...
          p("At baseline, 80% of PBFW were assumed to be on TLD, 50% of exposed infants received prophylaxis, and pregnant women received one HIV test during pregnancy. Outcomes included in this model are incident HIV infections among mothers and infants with associated intervention costs."),
      ...
      tabItem("model_description",
        tabBox(width=12,
          ...
          tabPanel("R model code",
            ...
            actionButton("copy_code_btn","Copy code"),
div(style="max-height:60vh; overflow-y:auto; border:1px solid #ccc; padding:10px;",
